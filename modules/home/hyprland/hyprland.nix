{ config, inputs, pkgs, ... }:
{
	...
	wayland.windowManager.hyprland = {
		...
		settings = {
			...
			# Monitors
			monitor = [
				"desc:LG Electronics LG UltraFine 704NTWGFD161, preferred, 0x0, 1"
				"desc:LG Electronics LG ULTRAGEAR 107NTKFCQ421, 2560x1440, auto-left, 1"
				"desc:Hewlett Packard HP Z24i CNK5330QXF, 1920x1200, auto-right, auto, transform, 1"
			];
